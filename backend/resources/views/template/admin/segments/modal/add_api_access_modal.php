<div class="modal fade" id="addApi" tabindex="-1" role="dialog" aria-labelledby="addApi" aria-hidden="true">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <center>
               <div class="alert alert-danger" id="add_key_errors"></div>
            </center>
            ...
            <div class="modal-footer">
               <button class="btn btn-primary btn-block" id="AddkeySubmit">Submit</button>
            </div>
            <br>
            </form>
         </div>
