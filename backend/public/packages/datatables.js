 ...
 *   https://datatables.net/download/#ju/dt-1.13.4/fh-3.3.2/sb-1.4.2
 *
 * Included libraries:
 *   DataTables 1.13.4, FixedHeader 3.3.2, SearchBuilder 1.4.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"ju/dt-1.13.4/fh-3.3.2/sb-1.4.2",
